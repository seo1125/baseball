       ...
       do {
           ...
           do {
               ...
               if((usr[0]==0)||(usr[1]==0)||(usr[2]==0)) {
                   System.err.println("0은 입력하지 마세요. 다시 입력해주세요.");
               } else if((usr[0]>9)||(usr[1]>9)||(usr[2]>9)) {
                   System.err.println("1부터 9까지의 숫자 중 하나를 입력해주세요. 다시 입력해주세요.");
               } else if((usr[0]==usr[1])||(usr[1]==usr[2])||(usr[0]==usr[2])) {
                   System.err.println("모두 다른 숫자를 입력해주세요. 다시 입력해주세요.");
               }
